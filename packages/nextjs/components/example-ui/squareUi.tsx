...
export const SquareUi = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-[url('/assets/gradient-bg.png')] bg-[length:100%_100%] py-2 px-5 sm:px-0 lg:py-auto max-w-[100vw] ">
      {/* Total count */}
